...
export function buildQueryPrompt(
  ...
  return [
    ...
    "The response mode is fixed. Return the same mode value you were given.",
    "Keep the answer concise and include only citations that support the answer.",
    "Set projectionPath to null for every citation. The local system will enrich bundle citations after parsing.",
    "",
    "BEGIN_QUERY_SCOPE",
    scope,
    "END_QUERY_SCOPE",
    ...
    "END_QUERY_MODE",
    "",
    "BEGIN_QUERY_TEMPLATE_INSTRUCTIONS",
    templateInstructions,
    "END_QUERY_TEMPLATE_INSTRUCTIONS",
    "",
